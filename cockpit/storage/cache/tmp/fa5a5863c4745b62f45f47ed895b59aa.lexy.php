                                            ...
                                            <div class="uk-width-1-1 uk-grid-margin">
                                                ...
                                                <div class="uk-form uk-form-horizontal">
                                                    ...
                                                    <div class="uk-form-row" data-ng-if="field.slug">
                                                        <label class="uk-form-label"><?php echo $app("i18n")->get('Unique'); ?></label>
                                                        <div class="uk-form-controls">
                                                    ...
                                                    <div class="uk-form-row" data-ng-if="field.type=='link-collection'">
                                                        <label class="uk-form-label"><?php echo $app("i18n")->get('Field on entries list page'); ?></label>
                                                        <div class="uk-form-controls">
                                                            <select ng-options="f.name as (f.label || '[' + f.name + ']') for f in getCollectionFields(field.collection)" data-ng-model="field.collectionField" title="<?php echo $app("i18n")->get('Show these fields in entries list'); ?>" data-uk-tooltip>
                                                                <option value=""><?php echo $app("i18n")->get('Collection Id'); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
